...
- [ ] **Record a CI-runner Lighthouse baseline** — then remove `continue-on-error` in `.github/workflows/ci.yml`; also re-record `4e8d0ba-dirty` after committing.
